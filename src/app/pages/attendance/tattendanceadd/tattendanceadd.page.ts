...
@Component({
  ...
  templateUrl: './tattendanceadd.page.html',
  styleUrls: ['./tattendanceadd.page.scss'],
})
export class TattendanceaddPage implements OnInit {
    ...
    addAttendance() {
        ...
        this.attendanceService.PostTattendance(allData)
            .then((data: any) => {
                ...
                this.Previetattendances = data.tattendances;
    ...
    getTattendance() {
        this.attendanceService.PostTattendance(null).then((data: any) => {
